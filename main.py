...
# Импортируем библиотеку и подключаем сторонний модуль.


def attack(char_name: str, char_class: str) -> str:
    """Определяет нанесенный урон, в зависимости от выбранного персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Определяет очки блокировки урона.

    Вычисляет урон в зависимости от выбранного персонажа.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Определяет супер-силу персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Определяет роль персонажа, в зависимости от выбора игрока."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предлагает выбор персонажей для игрока."""
...
print(inspect.cleandoc(defence.__doc__))
